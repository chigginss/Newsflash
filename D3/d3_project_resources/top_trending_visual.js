...
// }
// $("#return_trending_json_from_api").on("submit", submitOrder)
//load college major data
// d3.json("/info.json", function(d){
      ...
      .enter().append('circle')
        ...
        .on("mouseover", function(d) {
            div.transition()    
                .duration(200)    
                .style("opacity", .9);    
            div .html( "headline:" + d.title + "<br/>description:" + d.description + "<br/> authors" + d.authors + "<br/> url:" + d.url)
